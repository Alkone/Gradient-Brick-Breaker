...
public class UIManager : MonoBehaviour {
    ...
    public GameObject Game, game_text_level, game_text_checkpoint, game_text_ballcount, game_button_pause, game_button_return, game_coin, game_coin_text_coinscount;
